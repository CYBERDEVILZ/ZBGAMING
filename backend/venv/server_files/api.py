...
IMPORTANT!!!
EMAIL SHOULD BE MENTIONED AT ORGANIZER ACCOUNT

IMPORTANT!!!
REFUND MONEY LOGIC AND ORGANIZER BAD RAING LOGIC WHEN HE CANCELS THE MATCH MUST BE IMPLEMENTED IN THE API
...
IMPORTANT!!!
DISABLE TEAM BASES MATCHES IN CREATE MATCH SECTION
